...
python3 starter.py --results_path=rg_results_redo2/ --model_path=models_longer_redo2/ --architectures_file=architectures_longer.txt --seed=1826
python3 starter.py --results_path=rg_results_redo2/ --model_path=models_longer_redo2/ --architectures_file=architectures_longer.txt --seed=93946466
python3 starter.py --results_path=rg_results_redo2/ --model_path=models_longer_redo2/ --architectures_file=architectures_longer.txt --seed=1597534
